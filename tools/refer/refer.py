...
import numpy as np
from vilbert_beta.tools.refer.external import mask
# import cv2
...
class REFER:
	...
	def loadAnns(self, ann_ids=[]):
		...
		elif type(ann_ids) == int or type(ann_ids) == str: #changed unicode to str
...
if __name__ == '__main__':
	refer = REFER(data_root='D:\Code\VQA\VQA\vilbert_beta\tools\refer\data', dataset='refcocog', splitBy='google')
